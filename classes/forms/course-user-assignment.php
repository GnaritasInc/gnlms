...
<label style="margin-bottom: 0">Find users whose  
	<select name="search_field">
		<?php echo apply_filters('gnlms_course_user_search_field_options', '<option value="last_name">Last Name</option>'); ?>
	</select>
</label>
...
<?php if($context["course_id"]): ?><p><a href="#" class="gnlms-open-dialog" data-dialogid="gnlms-course-user-assignment">Register new users for this course</a></p><?php endif; ?>