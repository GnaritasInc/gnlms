jQuery(document).ready (function ($) {
	...
	listSelectInit();
		...
		$("div.listwidget").each( function (position, widget) {
	...
	function refreshContainedWidget (widgetContainer) {
		...
		console.log("Refresh Contained with params");
		console.log (params);
	...
	function loadPageComponent (selector, params, onComplete, onAjaxError) {
		...
		$(selector).load(
			gn_listWidget.ajaxURL,
			params,
			function (responseText, statusText, xhr) {
				if(onComplete) {
					onComplete(responseText, statusText, xhr);
			}
	...
	/*
	$.post(gn_listWidget.ajaxURL, params,
			function (responseText, statusText, xhr) {
				console.log (responseText);
				console.log (statusText);
				console.log (xhr);
